...
public class EsController {
    ...
    @ApiOperation(value = "根据id查询数据(查询主库)测试")
    ...
    @ApiOperation(value = "测试主从库(添加从库)测试")
    ...
    @ApiOperation(value = "es修改数据/添加数据")
    ...
    @ApiOperation(value = "根据id查询(多个id)")
    ...
    @ApiOperation(value = "对es复杂查询 排序(排序要配置type是否允许排序)")
